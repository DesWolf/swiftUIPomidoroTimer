...
struct Home: View {
        ...
        VStack(spacing: 15) {
            ...
            HStack(spacing: 15) {
                Text("\(pomodoroModel.hour) hr")
                    ...
                    .contextMenu {
                        сontextMenuOptions(maxValue: 12, hint: "hr") { value in
                ...
                Text("\(pomodoroModel.minutes) min")
                    ...
                    .contextMenu {
                        сontextMenuOptions(maxValue: 60, hint: "min") { value in
                ...
                Text("\(pomodoroModel.seconds) sec")
                    ...
                    .contextMenu {
                        сontextMenuOptions(maxValue: 60, hint: "sec") { value in
    ...
    @ViewBuilder
    func сontextMenuOptions(maxValue: Int,
                            hint: String,
                            onClick: @escaping (Int) -> ())-> some View {
